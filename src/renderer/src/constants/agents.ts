// This list must be synced manually when SupportedAgents.md is updated
...
export const AGENTS: Agent[] = [
  ...
  { name: 'Antigravity', agentFlag: 'antigravity', projectPath: '.gemini/antigravity/skills/', globalPath: '~/.gemini/antigravity/skills/' },
