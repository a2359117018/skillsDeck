...
- **新增/修改任何 UI 组件或样式时，必须先阅读根目录的 `DESIGN.md`**。DESIGN.md 是设计系统的规范文档，包含所有 design token 的定义、组件样式规则和 Agent 编码指南。
...
- `themeOverrides` 中禁止使用 `#000000` 或 `#ffffff`，使用 Carbon Ink (`#0a0a0a`) 和 Canvas (`#ffffff` 之外的对应值)
